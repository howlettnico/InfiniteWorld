...
namespace Custom_Rendering.Raytracing
{
    public class RaytracingManager : AppModule
    {
        ...
        [SerializeField] private Color directLight, indirectLight;
        ...
        void Update()
        {
            ...
            raytracingShader.SetVector("indirectLight", indirectLight);
            raytracingShader.SetVector("directLight", directLight);
